...
def gdf_to_json(gdf):
    """ Function to parse a GeoDataFrame to JSON format """
...
class Reader:
    ...
    def get_boundary(self):
        """ Retrieves Geometry from a shape file; outputs as a list """
    ...
    def get_input(self):
        """ Retrieves user inputs; outputs as a Point """
        ...
        #     return user_input(isle_bound)

    def get_buffer(self, location, data):
